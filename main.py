...
def main() -> None:
    ...
    p_paper.add_argument("--symbol", type=str, help="Trading pair (e.g. BTC/USDT)")
    ...
    p_trade.add_argument("--symbol", type=str, help="Trading pair (e.g. BTC/USDT)")
    ...
    if args.command == "paper":
        ...
        parser.print_help()
        print("\nExamples:")
        print("  python main.py paper                  # Start paper trading ($150 → $1000)")
        ...
        print("  python main.py trade --live           # Live trading")
